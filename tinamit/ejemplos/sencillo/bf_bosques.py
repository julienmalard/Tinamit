...
class PruebaBF(ModeloBF):
    ...
    def __init__(símismo):
        vars_ = VariablesMod([
            ...
            Variable('Bosques', unid='m2', ingr=True, egr=False, inic=1e6, líms=(0, None)),
        ])
    ...
    def incrementar(símismo, rebanada):
        ...
        símismo.variables['Lluvia'].poner_val(random.random() * min(1, bosques / 9e5)**5 * rebanada.n_pasos)
