...
if __name__ == "__main__":
    ...
    # egr = np.load("D:\Thesis\pythonProject\localuse\Dt\Mor\Mor_home\\anlzr\\625\\mor_625_paso.npy").tolist()
    ...
    #              paso, 0.1,
    #              "D:\Thesis\pythonProject\localuse\Dt\Mor\map\\prom\\")
    ...
    #     gof_prm = b_g['gof']
        ...
        #              path="D:\Thesis\pythonProject\localuse\Dt\Mor\map\spp\\bppprm\\")

        # for prm, gof in gof_prm.items():
        #     map_sens(gen_geog(), 'morris', list(simulation_data.keys())[0], prm,
        #              gof, 0.1, behav=patt,
        #              path="D:\Thesis\pythonProject\localuse\Dt\Mor\map\\spp\\aic\\")
    # FOR AZHAR
